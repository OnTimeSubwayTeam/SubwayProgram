...
public class DragImageView extends ImageView {
	...
	{
		//Log.d("DrawImageView","Click");
		scaleTask task=new scaleTask();
		task.execute(1);
		
	}
	
	public class scaleTask extends AsyncTask<Integer, Integer, Boolean>{
	...
	float setScale(float scale) {
		...
		return this.getHeight()/this.MAX_H;
	}
